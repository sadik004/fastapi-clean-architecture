...
- **Eager Loading Relational Hash Join (`selectinload` / `joinedload`)**: রিলেশনাল ডাটা প্রিফেচিং ও মেমোরি হ্যাশ ম্যাপে প্যারেন্ট-চাইল্ড গ্রাফ বাইন্ডিং ($\mathcal{O}(1)$ লুকআপ)।

### 🚀 প্রোডাকশনে ঠিক কখন ব্যবহার করব? (When to use in Production)
- **প্যারেন্ট-চাইল্ড রিলেশনশিপ ফেচিং**: ইউজার লিস্টের সাথে তাদের প্রোফাইল ও ভূমিকা, পোস্টের সাথে তাদের সব কমেন্ট প্রদর্শন।
- **অর্ডার হিস্ট্রি ও লাইন আইটেম ডিসপ্লে**: প্রতিটি অর্ডারের সাথে তার ভেতরের সমস্ত প্রোডাক্ট ডিটেইল এক রিকোয়েস্টে রিটার্ন করা।
- **মাল্টি-টিয়ার রোল ও পারমিশন রেজোলিউশন**: অথেন্টিকেশনের সময় ইউজারের সমস্ত রোল ও পারমিশন রিলেশনশিপ লোড করা।

### 🎯 কী কারণে বা কোন পরিস্থিতিতে ব্যবহার করব? (Why to use / Technical Triggers)
- **ডাটাবেস নেটওয়ার্ক স্যাচুরেশন ও N+1 এক্সপ্লোশন দূরীকরণ**: ১০০ জন ইউজারের জন্য ১টি কুয়েরি + ১০০টি আলাদা কুয়েরি মিলে ১০১টি কুয়েরি চালানোর বদলে ১টি বা ২টি অপ্টিমাইজড কুয়েরিতে নামিয়ে আনা।
- **সার্ভার রেসপন্স লেটেন্সি কমানো (৯৯% লেটেন্সি ড্রপ)**: ১০১টি কুয়েরিতে যদি ৫০০ms লাগতো, eager loading (`selectinload`/`joinedload`) ব্যবহার করে তা মাত্র ৫–১০ms এ সম্পন্ন হয়।
- **SQLAlchemy MissingGreenlet ও DetachedInstanceError নির্মূল**: অ্যাসিঙ্ক মোডে লেজি লোডিং করতে গেলে রানটাইমে ক্র্যাশ করে; eager loading নিশ্চিত করে সব ডাটা সেশন থাকা অবস্থায় মেমরিতে লোড হয়।
