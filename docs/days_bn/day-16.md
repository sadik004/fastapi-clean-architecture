...
- **Object Pool Design Pattern (`QueuePool` with Blocking Thread-Safe FIFO Queue) & Health-Check Heartbeat Ping**: ডেটাবেস কানেকশন পুলিং এবং অ্যাক্টিভ পিং অ্যালগরিদম (`pool_pre_ping=True`, `pool_recycle=1800`)।

### 🚀 প্রোডাকশনে ঠিক কখন ব্যবহার করব? (When to use in Production)
- হাই-ট্রাফিক এন্টারপ্রাইজ ওয়েব সার্ভিস, ক্লাউড ম্যানেজড ডাটাবেস (AWS RDS, Supabase, Neon), এবং ট্রাফিক স্পাইক ম্যানেজমেন্টে।

### 🎯 কী কারণে বা কোন পরিস্থিতিতে ব্যবহার করব? (Why to use / Technical Triggers)
- **কানেকশন হ্যান্ডশেক ওভারহেড দূরীকরণ**: প্রতি রিকোয়েস্টে নতুন TCP/SSL কানেকশন তৈরি করার ১০০ms+ অপচয় বন্ধ করে প্রি-ওয়ার্মড কানেকশন সাথে সাথে রি-ইউজ করা।
- **মরা কানেকশন (`OperationalError: server closed connection`) প্রতিরোধ**: ক্লাউড ফায়ারওয়াল বা প্রক্সি নিষ্ক্রিয় কানেকশন সাইলেন্টলি ড্রপ করে দিলে যাতে ভাঙা কানেকশন ক্লায়েন্টকে না দিয়ে পিং করে নতুন জীবন্ত কানেকশন দেওয়া যায়।
