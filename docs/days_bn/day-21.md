...
- **CPython 3.6+ Two-Tier Compact Hash Table (Sparse Array `_indices` + Dense Array `_entries`) & Pseudo-Random Perturbation Probing Recurrence ($i = ((5i + 1 + 	ext{perturb}) \pmod{2^k})$)**: সেন্টিনেল ভ্যালু (`EMPTY = -1`, `DUMMY = -2`) ভিত্তিক টু-টায়ার ওপেন অ্যাড্রেসিং হ্যাশ ম্যাপ।

### 🚀 প্রোডাকশনে ঠিক কখন ব্যবহার করব? (When to use in Production)
- আল্ট্রা-ফাস্ট লোকাল ইন-মেমোরি ক্যাশ, ইভেন্ট ডিডুপ্লিকেশন ইঞ্জিন, কাস্টম সেশন স্টোর এবং ইনসার্শন-অর্ডার নির্ভর হাই-থ্রুপুট কি-ভ্যালু লুকআপে।

### 🎯 কী কারণে বা কোন পরিস্থিতিতে ব্যবহার করব? (Why to use / Technical Triggers)
- **লিনিয়ার প্রোবিংয়ের প্রাইমারি ক্লাস্টারিং ও Hash DoS অ্যাটাক রুখে দেওয়া**: যখন আক্রমণকারী ইচ্ছাকৃতভাবে একই হ্যাশ কোডের শত শত কী পাঠিয়ে সাধারণ হ্যাশ টেবিলকে $\mathcal{O}(N)$ লিনিয়ার স্ক্যানে ধসিয়ে দিতে চায়; পার্টার্বেশন প্রোবিং হাইয়ার হ্যাশ বিট মিক্স করে সংঘর্ষ দ্রুত ছড়িয়ে দেয়।
- **সিপিইউ L1/L2 ক্যাশ লোকালিটি ও ইনসার্শন অর্ডার গ্যারান্টি**: ডেন্স অ্যারে মেমরিতে কনটিগুয়াস হওয়ায় ইটারেশন গতি বহুগুণ বৃদ্ধি পায়।
