...
- **Async Queue-Based Connection Pool (`asyncpg` / `QueuePool`) with FIFO/LIFO Recycling**: ডাটাবেস সকেট কানেকশন কিউ এবং লেটেন্সি এভয়েডেন্স পুলিং।

### 🚀 প্রোডাকশনে ঠিক কখন ব্যবহার করব? (When to use in Production)
- **হাই-ট্রাফিক PostgreSQL/MySQL ডাটাবেস ক্লাস্টার**: প্রতি সেকেন্ডে হাজার হাজার ডাটাবেস ট্রানজেকশন পরিচালনা।
- **সার্ভারলেস বা কনটেইনারাইজড ব্যাকএন্ড (Docker/K8s)**: মাইক্রোসার্ভিস স্কেল করার সময় ডাটাবেস কানেকশন লিমিট রক্ষা।
- **কোর ফিনটেক ও ট্রানজেকশনাল অ্যাকাউন্ট লেজার**: যেখানে প্রতি ডাটাবেস সেশনকে কঠোরভাবে আইসোলেটেড ও জিরো-লিক রাখতে হয়।

### 🎯 কী কারণে বা কোন পরিস্থিতিতে ব্যবহার করব? (Why to use / Technical Triggers)
- **কানেকশন এক্সহশন ও 'Too many connections' ক্র্যাশ প্রতিরোধ**: প্রতি রিকোয়েস্টে নতুন TCP কানেকশন খুললে ডাটাবেসের ম্যাক্সিমাম কানেকশন লিমিট শেষ হয়ে ডাটাবেস বন্ধ হয়ে যায়; পুলিং কানেকশন পুনরায় ব্যবহার করে কানেকশন সংখ্যা ফিক্সড রাখে।
- **TCP থ্রি-ওয়ে হ্যান্ডশেক ও TLS নেগোসিয়েশন ওভারহেড দূরীকরণ**: নতুন ডাটাবেস কানেকশন তৈরিতে ৫০–২০০ms সময় নষ্ট হয়; প্রি-ওয়ার্মড কানেকশন পুল থেকে কানেকশন নিলে কুয়েরি সাথে সাথে (<২ms) শুরু হয়।
- **হ্যাঙ্গিং আনক্লোজড সেশন ও মেমরি লিক নিরাময়**: এক্সেপশন উঠলে সেশন বন্ধ না হওয়ার সমস্যা সমাধান করতে `async with async_session_maker()` কন্টেক্সট ম্যানেজারের মাধ্যমে গ্যারান্টিড ক্লিনআপ।
