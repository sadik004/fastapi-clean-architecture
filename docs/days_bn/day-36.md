...
**রেডিস সর্টেড সেট (Redis ZSET) — স্কিপ লিস্ট (Skip List) ও হ্যাশ ম্যাপের যুগলবন্দী (O(log N) ইনসার্শন ও র্যাংক কোয়েরি, O(log N + M) রেঞ্জ রিট্রিভাল)**
...
- **রিয়েলটাইম গেমিং লিডারবোর্ড:** PUBG বা FreeFire-এ ১ লাখ প্লেয়ারের মধ্যে লাইভ টপ ১০ এবং নিজের লাইভ র্যাংক ডিসপ্লে করা।
- **ই-কমার্স বেস্টসেলার বা ট্রেন্ডিং আইটেম:** গত ১ ঘণ্টায় সবচেয়ে বেশি বিক্রি হওয়া বা ভিউ হওয়া টপ ২০টি প্রোডাক্টের রিয়েলটাইম র্যাংকিং।
- **সোশ্যাল মিডিয়া আপভোট ও হট পোস্ট ফিড:** রেডিট বা টুইটারের মতো আপভোটের ভিত্তিতে লাইভ ট্রেন্ডিং কনটেন্ট সাজানো।
- **স্লাইডিং উইন্ডো টাইমস্ট্যাম্প ট্র্যাকিং:** টাইমস্ট্যাম্পকে স্কোর বানিয়ে সময়ের ক্রমানুসারে নিখুঁত অর্ডার বজায় রাখা।
...
- **ডাটাবেসের ORDER BY score DESC কুয়েরি ওভারহেড সম্পূর্ণ ধ্বংস করতে:** প্রতি মুহূর্তে কোটি কোটি রো ডাটাবেসে সর্ট করতে গেলে ডাটাবেস ক্র্যাশ করে।
- **ডুপ্লিকেটহীন পারফেক্টলি সর্টেড ডেটা:** সেটের মতো মেম্বার ইউনিক থাকে, আবার স্কোরের ভিত্তিতে সবসময় সাজানো থাকে।
- **O(log N) জাম্পিং স্পিড:** প্লেয়ার সংখ্যা ১ কোটি হলেও স্কিপ লিস্টের ওপর দিয়ে মাত্র ২০টি জাম্পে স্কোর আপডেট ও র্যাংক পাওয়া যায়।
