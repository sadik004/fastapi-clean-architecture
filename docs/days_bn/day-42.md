...
## 📌 ব্যবহৃত DSA ও আর্কিটেকচারাল প্যাটার্নের নাম:
**আইডেমপোটেন্সি কি প্যাটার্ন ও ক্রিপ্টোগ্রাফিক রিকোয়েস্ট হ্যাশিং — Enterprise Idempotency Key Pattern with SHA-256 Request Digesting, Redis State Machine Mutex & O(1) Cached Response Replay**

---

## 🚀 প্রোডাকশনে ঠিক কখন ব্যবহার করব? (When to use in Production)
1. **Stripe, bKash ও SSLCommerz পেমেন্ট গেটওয়ে:** গ্রাহক যখন "Pay Now" বাটনে ক্লিক করেন এবং নেটওয়ার্ক ল্যাগের কারণে বাটনটি পরপর দুইবার চাপেন বা পেজ রিফ্রেশ করেন।
2. **ই-কমার্স চেকআউট ও অর্ডার সাবমিশন:** একই কার্টের পণ্যের জন্য একাধিক ইনভয়েস তৈরি বা একাধিকবার স্টক কেটে নেওয়া বন্ধ করতে।
3. **পেমেন্ট ওয়েবহুক প্রসেসিং (Webhook De-duplication):** পেমেন্ট গেটওয়েগুলো প্রায়শই একই ইভেন্টের জন্য একাধিকবার HTTP Webhook পাঠায়। সার্ভার যাতে একই সাবস্ক্রিপশন একাধিকবার রিনিউ না করে।
4. **ব্যাংক ফান্ড ট্রান্সফার ও এটিএম ক্যাশ আউট:** এক অ্যাকাউন্ট থেকে অন্য অ্যাকাউন্টে টাকা পাঠানোর সময় নেটওয়ার্ক ডিসকানেক্ট হলেও যেন গ্রাহকের অ্যাকাউন্ট থেকে দুইবার টাকা কেটে না নেওয়া হয়।

---

## 🎯 কী কারণে বা কোন পরিস্থিতিতে ব্যবহার করব? (Why to use / Technical Triggers)
1. **নেটওয়ার্ক টাইমআউটে ডাবল-চার্জিং চিরতরে বন্ধ করা:** ক্লায়েন্ট টাকা পাঠানোর পর সার্ভার টাকা কেটেছে ঠিকই, কিন্তু রেসপন্স ক্লায়েন্টের মোবাইলে পৌঁছানোর আগেই মোবাইল ডাটা ড্রপ করল। ক্লায়েন্ট অ্যাপ স্বয়ংক্রিয়ভাবে রিট্রাই করবে। আইডেমপোটেন্সি কি না থাকলে ক্লায়েন্টের ব্যাংক থেকে দুইবার টাকা কেটে যেত!
2. **পেলোড টেম্পারিং প্রতিরোধ:** হ্যাকার যদি ৫০ টাকার পেমেন্টের আইডেমপোটেন্সি কি চুরি করে ৫০০ টাকার নতুন অর্ডারে রিইউজ করতে চায়, SHA-256 হ্যাশ অমিল হওয়ায় সিস্টেম সাথে সাথে ৪২২ এরর দিয়ে আক্রমণ রুখে দেয়।
3. **ইন-ফ্লাইট ওভারল্যাপ প্রতিরোধ:** প্রথম রিকোয়েস্টের প্রসেসিং শেষ হওয়ার আগেই ব্যাক-টু-ব্যাক দ্বিতীয় রিকোয়েস্ট আসলে ৪0৯ কনফ্লিক্ট পাঠিয়ে রেস কন্ডিশন সম্পূর্ণ নির্মূল করা হয়।
