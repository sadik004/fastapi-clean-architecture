...
- **Unit of Work (UoW) Pattern & Multi-Repository State Machine**: একাধিক রিপোজিটরির ট্রানজেকশনাল অ্যাটমিসিটি নিশ্চিত করার জন্য ট্রানজেকশন কন্টেক্সট গ্রাফ।

### 🚀 প্রোডাকশনে ঠিক কখন ব্যবহার করব? (When to use in Production)
- **আর্থিক ব্যালেন্স ট্রান্সফার ও পেমেন্ট সেটেলমেন্ট**: এক অ্যাকাউন্ট থেকে টাকা কেটে অন্য অ্যাকাউন্টে যোগ করা।
- **অর্ডার প্লেসমেন্ট ও ইনভেন্টরি স্টক রিডাকশন**: কার্ট চেকআউটে অর্ডার তৈরি, ইনভেন্টরি থেকে স্টক কমানো এবং ইনভয়েস তৈরি একসাথে করা।
- **ইউজার রেজিস্ট্রেশন ও প্রোফাইল/অডিট লগ ক্রিয়েশন**: ইউজার রেকর্ড তৈরি, তার ডিফল্ট প্রোফাইল তৈরি ও অডিট লগ ইনসার্ট একটি একক অ্যাটমিক ট্রানজেকশনে সম্পন্ন করা।

### 🎯 কী কারণে বা কোন পরিস্থিতিতে ব্যবহার করব? (Why to use / Technical Triggers)
- **স্প্লিট-ব্রেইন ও আংশিক ব্যর্থতায় ডাটার অসঙ্গতি (Inconsistent State) রোধ**: প্রথম অপারেশন সফল হয়ে দ্বিতীয় অপারেশনে ক্র্যাশ করলে যাতে অর্ধেক ডাটা সেভ হয়ে টাকা বা স্টক গায়েব না হয়; UoW অল-অর-নাথিং (All-or-Nothing) গ্যারান্টি দেয়।
- **ট্রানজেকশন লক কনটেনশন ও ডেডলক পরিহার**: দীর্ঘ সময় ধরে ওপেন ডাটাবেস ট্রানজেকশন ধরে রাখলে অন্য সেশন ব্লক হয়ে ডেডলক হয়; UoW কন্টেক্সট ম্যানেজারে ট্রানজেকশনের লাইফস্প্যান ন্যূনতম সময়ে সীমাবদ্ধ রাখে।
- **ডার্টি রিড ও রেইস কন্ডিশন প্রতিরোধ**: ট্রানজেকশন সম্পন্ন (Commit) হওয়ার আগে অন্য কোনো কনকারেন্ট রিকোয়েস্ট যেন অসম্পূর্ণ ডাটা পড়তে না পারে (ACID Isolation)।
